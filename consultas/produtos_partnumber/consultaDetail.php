<?php
	...
	$sql = "SELECT id,
                    (select produto.cimcode from produto where produto.id = produtos_partnumber.produto_id )produto_id, 
                    (select partnumber.partnumber from partnumber where partnumber.id = produtos_partnumber.partnumber_id )partnumber_id
